...
def _extract_from_files(
    ...
    for report_file in report_files:
        ...
        if args_tup not in metricdb_dict:
            runtime_ = runtime[args_tup] if (runtime is not None) else None
            metricdb_dict[args_tup] = MetricsDatabase(categories, args_tup, runtime_ms=runtime_)
...
def generate_batch_of_graphs(
    ...
    metricdb_dict, sets = _extract_from_files(report_files, track_metrics, categories, runtime, extract_func)
    print('done')
